...
public class BitMask2Test {

    @Test
    public void checkFirstBitTest() {
        BitMask2 bm = new BitMask2(0x8000000000000000L);
    ...
    public void checkNumberBitTest() {
        for (int bitNumber = 0; bitNumber < 64; bitNumber++) {
            ...
            BitMask2 bm = new BitMask2(bitMask);
    ...
    public void adhocBitTest() {
        BitMask2 bm = new BitMask2(0xffffffffffffffffL);
//        System.out.println("Value: "
//                + Long.toBinaryString(bm.getBitMask2Value()));
        bm.unsetBit(10);
        bm.unsetBit(20);
        bm.unsetBit(30);
        bm.unsetBit(40);
